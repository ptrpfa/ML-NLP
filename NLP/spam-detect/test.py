...
svm_model = svm.SVC (C=1000, random_state = 123)
...
grid_search = GridSearchCV (estimator = svm_model, param_grid = parameter_grid, 
...
list_cross_val_score = cross_val_score (svm_model, features, target, cv = 5, scoring = 'accuracy')
