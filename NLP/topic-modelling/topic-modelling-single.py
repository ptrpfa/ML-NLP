...
""" 
NOTE: 
This program takes in a specified CATEGORY and WEB_APP_ID for Topic Modelling. To conduct Topic Modelling on multiple categories in which their optimal number
of topics have been obtained, run the topic-modelling.py program
...
# File paths
train_file_path = "%sdata/feedback-ml.csv" % working_directory                  # Dataset file path (prior to topic modelling)
topic_file_path = '%sdata/feedback-ml-topics.csv' % working_directory           # Topic modelled dataset file path
topics_file_path = '%sdata/topics.txt' % working_directory                      # File path of topic details
topics_df_file_path = '%sdata/topics.csv' % working_directory                   # File path of topics table
feedback_topics_df_file_path = '%sdata/feedback-topics.csv' % working_directory # File path of feedback-topics table
